...
<head>
    ...
    <title>ASO Rank Guard - Dashboard Interactive Pro</title>
...
<body>
    <div class="container">
        <header>
            ...
            <h1>
                <i data-lucide="rocket" style="width: 48px; height: 48px; display: inline-block; vertical-align: middle; margin-right: 10px;"></i>
                ASO Rank Guard Pro
            </h1>
            <p class="subtitle">Dashboard Interactive · Advanced Analytics & Insights</p>
                                    ...
                                    <tbody>
                                        ${COMPETITORS_DATA.slice(0, 50).map(c => `
                                            <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
                                                ...
                                                <td style="padding: 8px; text-align: center;">⭐ ${parseFloat(c.rating || 0).toFixed(1)}</td>
                                            </tr>
                                        `).join('')}
                                    </tbody>
                                </table>
